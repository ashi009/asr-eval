...
// currentEnableNonstream is the globally configured nonstream setting
var currentEnableNonstream = true

func SetEnableNonstream(enabled bool) {
...
func NewFullClientRequest(meta *RequestMeta) []byte {
	...
	log.Printf("Full client request payload: %s", string(payloadArr))
